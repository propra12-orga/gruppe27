...
public class LevelEditor extends Level implements Serializable {
	...
	/**
	 *  Frame initialisieren und Sichtbar machen. Feste Groeﬂe. Mittig
	 *	ausrichten
	 */
	 ...
	 * umsetzt und fÔøΩr das Ende der ersten Dimension immer ein Semikolon setzt.
	 * 
	 ...
	 *         erfolgreichem Export zurÔøΩck.
	 */
	public boolean exportlvl(String filepath, Properties ToBeSaved) {
		String manual = "\nInformationen:\n0 ist ein begehbarer Weg\n1 ist ein unzerstÔøΩrbarer Block\n2 ist ein zerstÔøΩrbarer Block\n3 ist ein Ausgang\n4 ist ein Versteck";
		if (filepath != null) {
			try {
				...
				// den
				// OutPutStream.
				bos.close(); // Datei/Stream schlieÔøΩen
				return true; // Wenn erfolgreich true zurÔøΩckgeben
