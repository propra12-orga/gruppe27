...
public class Startmenue {
	...
	public void menueaufruf() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					system.setlevelpath(filedialog.loadFile(new Frame(),
							...
							"*.bml")); // Parameter an neuen Dialog �bergeben
		 ...
		 * 
		 * Optionsmen� wird in neuem Fenster aufgerufen �nderungen der
		 * Optionen werden �bernommen und in der system-Instanz gespeichert
		 */
